...
= 3.1 =
* Add new format for API key as require by Etsy: keystring:secret

= 3.0.7 =
* Use esc_attr instaed of wp_filter

= 3.0.6 =
* Escaping some data to prevent Cross-Site Scripting on actions
